...
A) class Normal extends Thread{
    public void run(){ System.out.println("Thread is Running... thread extend method"); }
}
class Run implements Runnable{
    public void run(){System.out.println("Thread is running.. by Runnable Interface method"); }
}
